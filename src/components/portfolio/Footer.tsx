...
export const FooterPortfolio = () => {
    return (
        <footer className='footer-home'>
            <div id="footer_content_portfolio">

                <div id="footer_contacts_portfolio">
                    <h1>
                        <FontAwesomeIcon icon={faFlag} className='icon' />
                        Logo
                    </h1>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
                    <div id="footer_social_media_portfolio">
                ...
                {/* <div id="footer_subscribe_portfolio">
                    <h3>Fale Conosco</h3>
            ...
            <div id="footer_copyright_portfolio">
